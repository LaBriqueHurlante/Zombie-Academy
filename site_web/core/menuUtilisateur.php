<div id="menuUti">
    ...
    <li id="cerveauCo" class="cerveau-avatar co"><a class="survol8" href="../pages/chambre.php" style="margin-top: 6px;display: block;"><img src="css/media/img/recompenses/Cerveauactif.png" /></a></li>
